-- Migration: Fix search_persons_unified function
-- This ensures the function return type matches the query structure
-- Run this if you get "structure of query does not match function result type" errors
...
DROP FUNCTION IF EXISTS search_persons_unified(TEXT, TEXT, UUID, UUID, UUID, TEXT, BOOLEAN, INT, INT, TEXT, INT, INT);
...
BEGIN
    ...
    SELECT
        ...
        p."AvatarMediaId" AS avatar_media_id,
        m."Url" AS avatar_url
    FROM public."People" p
