...
public partial class AddPersonAvatar : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.AddForeignKey(
            ...
            table: "People",
            column: "AvatarMediaId",
            principalTable: "MediaFiles",  // Correct table name
            principalColumn: "Id",
...
**Note:** The table is `MediaFiles` (not `Media`).
...
// Navigation property (MediaFile is the model for MediaFiles table)
public MediaFile? Avatar { get; set; }
```

**Note:** Check your actual model class name - it might be `MediaFile` or `Media`.
