...
\restrict CvHkbfraqY1rnyvESajHdUrUqI0TEaoeWGCJd96O9ajMlLwcNd7YOaFgw2eV0L6

-- Dumped from database version 15.15 (Ubuntu 15.15-1.pgdg22.04+1)
-- Dumped by pg_dump version 18.0

-- Started on 2026-01-27 17:26:10
...
--
-- TOC entry 332 (class 1255 OID 106797)
...
--
-- TOC entry 334 (class 1255 OID 109256)
-- Name: fn_check_duplicate_suggestion(uuid, integer, uuid, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_check_duplicate_suggestion(p_tree_id uuid, p_type integer, p_target_person_id uuid, p_secondary_person_id uuid DEFAULT NULL::uuid) RETURNS TABLE(suggestion_id uuid, submitted_at timestamp with time zone, submitter_name text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.fn_check_duplicate_suggestion(p_tree_id uuid, p_type integer, p_target_person_id uuid, p_secondary_person_id uuid) OWNER TO postgres;

--
-- TOC entry 4024 (class 0 OID 0)
-- Dependencies: 334
-- Name: FUNCTION fn_check_duplicate_suggestion(p_tree_id uuid, p_type integer, p_target_person_id uuid, p_secondary_person_id uuid); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION public.fn_check_duplicate_suggestion(p_tree_id uuid, p_type integer, p_target_person_id uuid, p_secondary_person_id uuid) IS 'Checks if a similar pending suggestion already exists to prevent duplicates';


--
-- TOC entry 333 (class 1255 OID 109255)
-- Name: fn_get_suggestion_statistics(uuid, uuid, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_get_suggestion_statistics(p_town_id uuid DEFAULT NULL::uuid, p_tree_id uuid DEFAULT NULL::uuid, p_user_id bigint DEFAULT NULL::bigint) RETURNS TABLE(total_count bigint, pending_count bigint, approved_count bigint, rejected_count bigint, needs_info_count bigint, withdrawn_count bigint, avg_review_time_hours numeric, oldest_pending_days integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.fn_get_suggestion_statistics(p_town_id uuid, p_tree_id uuid, p_user_id bigint) OWNER TO postgres;

--
-- TOC entry 4025 (class 0 OID 0)
-- Dependencies: 333
-- Name: FUNCTION fn_get_suggestion_statistics(p_town_id uuid, p_tree_id uuid, p_user_id bigint); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION public.fn_get_suggestion_statistics(p_town_id uuid, p_tree_id uuid, p_user_id bigint) IS 'Returns suggestion statistics for a given scope (town, tree, or user)';


--
-- TOC entry 335 (class 1255 OID 109257)
-- Name: fn_update_suggestion_timestamp(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_update_suggestion_timestamp() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.fn_update_suggestion_timestamp() OWNER TO postgres;

--
-- TOC entry 330 (class 1255 OID 106400)
...
--
-- TOC entry 331 (class 1255 OID 106401)
...
--
-- TOC entry 327 (class 1255 OID 106067)
...
--
-- TOC entry 328 (class 1255 OID 106068)
...
--
-- TOC entry 329 (class 1255 OID 106069)
...
--
-- TOC entry 336 (class 1255 OID 114985)
...
-- Dependencies: 336
-- Name: FUNCTION search_persons_unified(p_query text, p_search_in text, p_tree_id uuid, p_town_id uuid, p_family_id uuid, p_sex text, p_is_living boolean, p_birth_year_from integer, p_birth_year_to integer, p_nationality text, p_page integer, p_page_size integer); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION public.search_persons_unified(p_query text, p_search_in text, p_tree_id uuid, p_town_id uuid, p_family_id uuid, p_sex text, p_is_living boolean, p_birth_year_from integer, p_birth_year_to integer, p_nationality text, p_page integer, p_page_size integer) IS 'Unified person search with soft delete support - excludes deleted records';


--
-- TOC entry 326 (class 1255 OID 72730)
...
-- Dependencies: 229
-- Name: COLUMN "AuditLogs"."ActorId"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."AuditLogs"."ActorId" IS 'User ID (bigint) of the actor who performed the action. References AspNetUsers.Id.';


--
-- TOC entry 4036 (class 0 OID 0)
-- Dependencies: 229
-- Name: COLUMN "AuditLogs"."SuggestionId"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."AuditLogs"."SuggestionId" IS 'Reference to the suggestion that triggered this change (if applicable).';


--
-- TOC entry 4037 (class 0 OID 0)
-- Dependencies: 229
-- Name: COLUMN "AuditLogs"."PreviousValuesJson"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."AuditLogs"."PreviousValuesJson" IS 'JSON snapshot of entity state before the change. Used for rollback.';


--
-- TOC entry 4038 (class 0 OID 0)
-- Dependencies: 229
-- Name: COLUMN "AuditLogs"."NewValuesJson"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."AuditLogs"."NewValuesJson" IS 'JSON snapshot of entity state after the change.';
...
-- Dependencies: 224
-- Name: COLUMN "ParentChildren"."IsDeleted"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."ParentChildren"."IsDeleted" IS 'Soft delete flag. TRUE means relationship is deleted but preserved for audit.';


--
-- TOC entry 4056 (class 0 OID 0)
-- Dependencies: 224
-- Name: COLUMN "ParentChildren"."DeletedAt"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."ParentChildren"."DeletedAt" IS 'Timestamp when the relationship was soft deleted.';


--
-- TOC entry 4057 (class 0 OID 0)
-- Dependencies: 224
-- Name: COLUMN "ParentChildren"."DeletedByUserId"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."ParentChildren"."DeletedByUserId" IS 'User who performed the soft delete.';
...
-- Dependencies: 221
-- Name: COLUMN "People"."IsDeleted"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."People"."IsDeleted" IS 'Soft delete flag. TRUE means record is deleted but preserved for audit.';


--
-- TOC entry 4062 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN "People"."DeletedAt"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."People"."DeletedAt" IS 'Timestamp when the record was soft deleted.';


--
-- TOC entry 4063 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN "People"."DeletedByUserId"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."People"."DeletedByUserId" IS 'User who performed the soft delete.';
...
--
-- TOC entry 265 (class 1259 OID 109129)
-- Name: RelationshipSuggestions; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."RelationshipSuggestions" (
    "Id" uuid DEFAULT gen_random_uuid() NOT NULL,
    "TownId" uuid NOT NULL,
    "TreeId" uuid NOT NULL,
    ...
    "TargetUnionId" uuid,
    "ProposedValuesJson" jsonb DEFAULT '{}'::jsonb NOT NULL,
    ...
    "SubmitterNotes" character varying(1000),
    "ReviewedByUserId" bigint,
    "ReviewedAt" timestamp with time zone,
    "ReviewerNotes" character varying(1000),
    "AppliedEntityType" character varying(50),
...
ALTER TABLE public."RelationshipSuggestions" OWNER TO postgres;

--
-- TOC entry 4072 (class 0 OID 0)
-- Dependencies: 265
-- Name: TABLE "RelationshipSuggestions"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public."RelationshipSuggestions" IS 'Stores structured relationship suggestions from viewers. Only Admins can approve and apply changes to canonical tree.';


--
-- TOC entry 4073 (class 0 OID 0)
-- Dependencies: 265
-- Name: COLUMN "RelationshipSuggestions"."Type"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."RelationshipSuggestions"."Type" IS 'Suggestion type: 0=AddPerson, 1=UpdatePerson, 2=AddParent, 3=AddChild, 4=AddSpouse, 5=RemoveRelationship, 6=MergePerson, 7=SplitPerson';


--
-- TOC entry 4074 (class 0 OID 0)
-- Dependencies: 265
-- Name: COLUMN "RelationshipSuggestions"."ProposedValuesJson"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."RelationshipSuggestions"."ProposedValuesJson" IS 'JSON object containing proposed field values (names, dates, places, etc.)';


--
-- TOC entry 4075 (class 0 OID 0)
-- Dependencies: 265
-- Name: COLUMN "RelationshipSuggestions"."Confidence"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."RelationshipSuggestions"."Confidence" IS 'Submitter confidence level: 0=Certain, 1=Probable, 2=Possible, 3=Uncertain';


--
-- TOC entry 4076 (class 0 OID 0)
-- Dependencies: 265
-- Name: COLUMN "RelationshipSuggestions"."Status"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."RelationshipSuggestions"."Status" IS 'Status workflow: 0=Pending, 1=Approved, 2=Rejected, 3=NeedsInfo, 4=Withdrawn';


--
-- TOC entry 4077 (class 0 OID 0)
-- Dependencies: 265
-- Name: COLUMN "RelationshipSuggestions"."AppliedEntityType"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."RelationshipSuggestions"."AppliedEntityType" IS 'Type of entity created/modified when approved (Person, ParentChild, Union)';


--
-- TOC entry 4078 (class 0 OID 0)
-- Dependencies: 265
-- Name: COLUMN "RelationshipSuggestions"."AppliedEntityId"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."RelationshipSuggestions"."AppliedEntityId" IS 'ID of entity created/modified when approved. Used for rollback.';


--
-- TOC entry 4079 (class 0 OID 0)
-- Dependencies: 265
-- Name: COLUMN "RelationshipSuggestions"."PreviousValuesJson"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."RelationshipSuggestions"."PreviousValuesJson" IS 'JSON snapshot of entity state before approval. Used for rollback.';
...
--
-- TOC entry 267 (class 1259 OID 109219)
-- Name: SuggestionComments; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."SuggestionComments" (
    "Id" uuid DEFAULT gen_random_uuid() NOT NULL,
...
ALTER TABLE public."SuggestionComments" OWNER TO postgres;

--
-- TOC entry 4080 (class 0 OID 0)
-- Dependencies: 267
-- Name: TABLE "SuggestionComments"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public."SuggestionComments" IS 'Conversation thread between suggestion submitter and admin reviewers';


--
-- TOC entry 4081 (class 0 OID 0)
-- Dependencies: 267
-- Name: COLUMN "SuggestionComments"."IsAdminComment"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."SuggestionComments"."IsAdminComment" IS 'TRUE if comment is from an admin/reviewer, FALSE if from the submitter';


--
-- TOC entry 266 (class 1259 OID 109195)
-- Name: SuggestionEvidence; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."SuggestionEvidence" (
    "Id" uuid DEFAULT gen_random_uuid() NOT NULL,
    "SuggestionId" uuid NOT NULL,
    "Type" integer NOT NULL,
    "MediaId" uuid,
    "Url" character varying(2000),
    "UrlTitle" character varying(200),
    "Description" character varying(500),
    "SortOrder" integer DEFAULT 0 NOT NULL,
    "CreatedAt" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT "CK_SuggestionEvidence_HasSource" CHECK ((("MediaId" IS NOT NULL) OR ("Url" IS NOT NULL))),
    CONSTRAINT "CK_SuggestionEvidence_Type" CHECK ((("Type" >= 0) AND ("Type" <= 5)))
);


ALTER TABLE public."SuggestionEvidence" OWNER TO postgres;

--
-- TOC entry 4082 (class 0 OID 0)
-- Dependencies: 266
-- Name: TABLE "SuggestionEvidence"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public."SuggestionEvidence" IS 'Evidence attachments supporting suggestions (photos, documents, audio, video, URLs)';


--
-- TOC entry 4083 (class 0 OID 0)
-- Dependencies: 266
-- Name: COLUMN "SuggestionEvidence"."Type"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."SuggestionEvidence"."Type" IS 'Evidence type: 0=Photo, 1=Document, 2=Audio, 3=Video, 4=Url, 5=OtherMedia';


--
-- TOC entry 4084 (class 0 OID 0)
-- Dependencies: 266
-- Name: COLUMN "SuggestionEvidence"."MediaId"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."SuggestionEvidence"."MediaId" IS 'Reference to uploaded media file in MediaFiles table';
...
-- Dependencies: 222
-- Name: COLUMN "Unions"."IsDeleted"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."Unions"."IsDeleted" IS 'Soft delete flag. TRUE means union is deleted but preserved for audit.';


--
-- TOC entry 4087 (class 0 OID 0)
-- Dependencies: 222
-- Name: COLUMN "Unions"."DeletedAt"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."Unions"."DeletedAt" IS 'Timestamp when the union was soft deleted.';


--
-- TOC entry 4088 (class 0 OID 0)
-- Dependencies: 222
-- Name: COLUMN "Unions"."DeletedByUserId"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."Unions"."DeletedByUserId" IS 'User who performed the soft delete.';
...
--
-- TOC entry 268 (class 1259 OID 109245)
-- Name: vw_pending_suggestions_by_town; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_pending_suggestions_by_town AS
 SELECT t."Id" AS "TownId",
   ...
   FROM (public."Towns" t
     LEFT JOIN public."RelationshipSuggestions" rs ON (((rs."TownId" = t."Id") AND (rs."Status" = 0) AND (rs."IsDeleted" = false))))
  GROUP BY t."Id", t."Name", t."NameEn", t."NameAr";


ALTER VIEW public.vw_pending_suggestions_by_town OWNER TO postgres;

--
-- TOC entry 4089 (class 0 OID 0)
-- Dependencies: 268
-- Name: VIEW vw_pending_suggestions_by_town; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON VIEW public.vw_pending_suggestions_by_town IS 'Aggregates pending suggestion counts by town for admin dashboard';


--
-- TOC entry 269 (class 1259 OID 109250)
-- Name: vw_suggestion_queue; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_suggestion_queue AS
 SELECT rs."Id",
    rs."Type",
    rs."Status",
    rs."Confidence",
    ...
    ( SELECT count(*) AS count
           FROM public."SuggestionEvidence" se
          WHERE (se."SuggestionId" = rs."Id")) AS "EvidenceCount",
    ( SELECT count(*) AS count
           FROM public."SuggestionComments" sc
          WHERE (sc."SuggestionId" = rs."Id")) AS "CommentCount"
   FROM (((((public."RelationshipSuggestions" rs
     JOIN public."Towns" t ON ((t."Id" = rs."TownId")))
     JOIN public."Orgs" o ON ((o."Id" = rs."TreeId")))
     JOIN public."AspNetUsers" su ON ((su."Id" = rs."SubmittedByUserId")))
     LEFT JOIN public."People" tp ON ((tp."Id" = rs."TargetPersonId")))
     LEFT JOIN public."People" sp ON ((sp."Id" = rs."SecondaryPersonId")))
  WHERE (rs."IsDeleted" = false);


ALTER VIEW public.vw_suggestion_queue OWNER TO postgres;

--
-- TOC entry 4090 (class 0 OID 0)
-- Dependencies: 269
-- Name: VIEW vw_suggestion_queue; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON VIEW public.vw_suggestion_queue IS 'Detailed suggestion view with joined data for admin queue display';


--
-- TOC entry 3527 (class 2604 OID 72931)
...
--
-- TOC entry 3536 (class 2604 OID 72971)
...
--
-- TOC entry 3706 (class 2606 OID 72650)
...
--
-- TOC entry 3654 (class 2606 OID 71276)
...
--
-- TOC entry 3770 (class 2606 OID 108807)
...
--
-- TOC entry 3751 (class 2606 OID 73011)
...
--
-- TOC entry 3732 (class 2606 OID 72936)
...
--
-- TOC entry 3642 (class 2606 OID 71217)
...
--
-- TOC entry 3749 (class 2606 OID 72978)
...
--
-- TOC entry 3595 (class 2606 OID 71051)
...
--
-- TOC entry 3587 (class 2606 OID 71028)
...
--
-- TOC entry 3761 (class 2606 OID 73054)
...
--
-- TOC entry 3673 (class 2606 OID 72453)
...
--
-- TOC entry 3660 (class 2606 OID 72449)
...
--
-- TOC entry 3686 (class 2606 OID 72463)
...
--
-- TOC entry 3676 (class 2606 OID 72455)
...
--
-- TOC entry 3679 (class 2606 OID 72457)
...
--
-- TOC entry 3682 (class 2606 OID 72459)
...
--
-- TOC entry 3684 (class 2606 OID 72461)
...
--
-- TOC entry 3666 (class 2606 OID 72451)
...
--
-- TOC entry 3768 (class 2606 OID 106658)
...
--
-- TOC entry 3690 (class 2606 OID 72467)
...
--
-- TOC entry 3787 (class 2606 OID 109146)
-- Name: RelationshipSuggestions PK_RelationshipSuggestions; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "PK_RelationshipSuggestions" PRIMARY KEY ("Id");


--
-- TOC entry 3696 (class 2606 OID 72471)
...
--
-- TOC entry 3794 (class 2606 OID 109228)
-- Name: SuggestionComments PK_SuggestionComments; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SuggestionComments"
    ADD CONSTRAINT "PK_SuggestionComments" PRIMARY KEY ("Id");


--
-- TOC entry 3791 (class 2606 OID 109206)
-- Name: SuggestionEvidence PK_SuggestionEvidence; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SuggestionEvidence"
    ADD CONSTRAINT "PK_SuggestionEvidence" PRIMARY KEY ("Id");


--
-- TOC entry 3730 (class 2606 OID 72819)
...
--
-- TOC entry 3726 (class 2606 OID 72811)
...
--
-- TOC entry 3633 (class 2606 OID 71192)
...
--
-- TOC entry 3611 (class 2606 OID 71101)
...
--
-- TOC entry 3702 (class 2606 OID 72618)
...
--
-- TOC entry 3722 (class 2606 OID 72708)
...
--
-- TOC entry 3740 (class 2606 OID 72951)
...
--
-- TOC entry 3652 (class 2606 OID 71256)
...
--
-- TOC entry 3694 (class 2606 OID 72469)
...
--
-- TOC entry 3599 (class 2606 OID 71071)
...
--
-- TOC entry 3646 (class 2606 OID 71239)
...
--
-- TOC entry 3649 (class 2606 OID 71248)
...
--
-- TOC entry 3777 (class 2606 OID 108855)
...
--
-- TOC entry 3715 (class 2606 OID 72679)
...
--
-- TOC entry 3717 (class 2606 OID 72677)
...
--
-- TOC entry 3763 (class 2606 OID 73056)
...
--
-- TOC entry 3710 (class 2606 OID 72652)
...
--
-- TOC entry 3704 (class 2606 OID 72620)
...
--
-- TOC entry 3724 (class 2606 OID 72710)
...
--
-- TOC entry 3625 (class 2606 OID 71171)
...
--
-- TOC entry 3622 (class 2606 OID 71152)
...
--
-- TOC entry 3590 (class 2606 OID 71042)
...
--
-- TOC entry 3592 (class 2606 OID 71040)
...
--
-- TOC entry 3688 (class 2606 OID 72465)
...
--
-- TOC entry 3663 (class 1259 OID 72472)
...
--
-- TOC entry 3757 (class 1259 OID 73074)
...
--
-- TOC entry 3758 (class 1259 OID 73073)
...
--
-- TOC entry 3759 (class 1259 OID 73072)
...
--
-- TOC entry 3707 (class 1259 OID 72669)
...
--
-- TOC entry 3708 (class 1259 OID 72668)
...
--
-- TOC entry 3671 (class 1259 OID 72478)
...
--
-- TOC entry 3674 (class 1259 OID 72479)
...
--
-- TOC entry 3677 (class 1259 OID 72480)
...
--
-- TOC entry 3680 (class 1259 OID 72481)
...
--
-- TOC entry 3664 (class 1259 OID 106831)
...
--
-- TOC entry 3655 (class 1259 OID 109271)
...
--
-- TOC entry 3656 (class 1259 OID 71283)
...
--
-- TOC entry 3657 (class 1259 OID 109128)
-- Name: IX_AuditLogs_SuggestionId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_AuditLogs_SuggestionId" ON public."AuditLogs" USING btree ("SuggestionId") WHERE ("SuggestionId" IS NOT NULL);


--
-- TOC entry 3658 (class 1259 OID 71284)
...
--
-- TOC entry 3771 (class 1259 OID 108809)
...
--
-- TOC entry 3772 (class 1259 OID 108808)
...
--
-- TOC entry 3764 (class 1259 OID 106660)
...
--
-- TOC entry 3765 (class 1259 OID 106659)
...
--
-- TOC entry 3766 (class 1259 OID 106661)
...
--
-- TOC entry 3752 (class 1259 OID 73039)
...
--
-- TOC entry 3753 (class 1259 OID 73037)
...
--
-- TOC entry 3754 (class 1259 OID 73040)
...
--
-- TOC entry 3755 (class 1259 OID 73038)
...
--
-- TOC entry 3756 (class 1259 OID 73075)
...
--
-- TOC entry 3733 (class 1259 OID 72938)
...
--
-- TOC entry 3734 (class 1259 OID 72939)
...
--
-- TOC entry 3735 (class 1259 OID 72937)
...
--
-- TOC entry 3636 (class 1259 OID 72729)
...
--
-- TOC entry 3637 (class 1259 OID 71228)
...
--
-- TOC entry 3638 (class 1259 OID 72893)
...
--
-- TOC entry 3639 (class 1259 OID 71229)
...
--
-- TOC entry 3640 (class 1259 OID 72728)
...
--
-- TOC entry 3741 (class 1259 OID 72989)
...
--
-- TOC entry 3742 (class 1259 OID 72995)
...
--
-- TOC entry 3743 (class 1259 OID 72990)
...
--
-- TOC entry 3744 (class 1259 OID 72993)
...
--
-- TOC entry 3745 (class 1259 OID 72992)
...
--
-- TOC entry 3746 (class 1259 OID 72991)
...
--
-- TOC entry 3747 (class 1259 OID 72994)
...
--
-- TOC entry 3593 (class 1259 OID 72544)
...
--
-- TOC entry 3582 (class 1259 OID 72604)
...
--
-- TOC entry 3583 (class 1259 OID 71029)
...
--
-- TOC entry 3584 (class 1259 OID 72603)
...
--
-- TOC entry 3585 (class 1259 OID 72822)
...
--
-- TOC entry 3628 (class 1259 OID 71204)
...
--
-- TOC entry 3629 (class 1259 OID 108891)
-- Name: IX_ParentChildren_IsDeleted; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_ParentChildren_IsDeleted" ON public."ParentChildren" USING btree ("IsDeleted") WHERE ("IsDeleted" = false);


--
-- TOC entry 3630 (class 1259 OID 71203)
...
--
-- TOC entry 3631 (class 1259 OID 71205)
...
--
-- TOC entry 3600 (class 1259 OID 106669)
...
--
-- TOC entry 3601 (class 1259 OID 73041)
...
--
-- TOC entry 3602 (class 1259 OID 108884)
-- Name: IX_People_IsDeleted; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_People_IsDeleted" ON public."People" USING btree ("IsDeleted") WHERE ("IsDeleted" = false);


--
-- TOC entry 3603 (class 1259 OID 106271)
...
--
-- TOC entry 3604 (class 1259 OID 106272)
...
--
-- TOC entry 3605 (class 1259 OID 106273)
...
--
-- TOC entry 3606 (class 1259 OID 106664)
...
--
-- TOC entry 3607 (class 1259 OID 71117)
...
--
-- TOC entry 3608 (class 1259 OID 71118)
...
--
-- TOC entry 3609 (class 1259 OID 71119)
...
--
-- TOC entry 3698 (class 1259 OID 72641)
...
--
-- TOC entry 3699 (class 1259 OID 72643)
...
--
-- TOC entry 3700 (class 1259 OID 72642)
...
--
-- TOC entry 3718 (class 1259 OID 72722)
...
--
-- TOC entry 3719 (class 1259 OID 72721)
...
--
-- TOC entry 3720 (class 1259 OID 72894)
...
--
-- TOC entry 3736 (class 1259 OID 72963)
...
--
-- TOC entry 3737 (class 1259 OID 72962)
...
--
-- TOC entry 3738 (class 1259 OID 72964)
...
--
-- TOC entry 3650 (class 1259 OID 71267)
...
--
-- TOC entry 3596 (class 1259 OID 71082)
...
--
-- TOC entry 3597 (class 1259 OID 71083)
...
--
-- TOC entry 3778 (class 1259 OID 109192)
-- Name: IX_RelationshipSuggestions_CreatedAt; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_RelationshipSuggestions_CreatedAt" ON public."RelationshipSuggestions" USING btree ("CreatedAt" DESC);


--
-- TOC entry 3779 (class 1259 OID 109194)
-- Name: IX_RelationshipSuggestions_NoDuplicatePending; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "IX_RelationshipSuggestions_NoDuplicatePending" ON public."RelationshipSuggestions" USING btree ("TreeId", "Type", COALESCE("TargetPersonId", '00000000-0000-0000-0000-000000000000'::uuid), COALESCE("SecondaryPersonId", '00000000-0000-0000-0000-000000000000'::uuid)) WHERE (("Status" = 0) AND ("IsDeleted" = false));


--
-- TOC entry 3780 (class 1259 OID 109189)
-- Name: IX_RelationshipSuggestions_Status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_RelationshipSuggestions_Status" ON public."RelationshipSuggestions" USING btree ("Status") WHERE ("IsDeleted" = false);


--
-- TOC entry 3781 (class 1259 OID 109190)
-- Name: IX_RelationshipSuggestions_SubmittedByUserId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_RelationshipSuggestions_SubmittedByUserId" ON public."RelationshipSuggestions" USING btree ("SubmittedByUserId");


--
-- TOC entry 3782 (class 1259 OID 109191)
-- Name: IX_RelationshipSuggestions_TargetPersonId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_RelationshipSuggestions_TargetPersonId" ON public."RelationshipSuggestions" USING btree ("TargetPersonId") WHERE ("TargetPersonId" IS NOT NULL);


--
-- TOC entry 3783 (class 1259 OID 109187)
-- Name: IX_RelationshipSuggestions_TownId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_RelationshipSuggestions_TownId" ON public."RelationshipSuggestions" USING btree ("TownId");


--
-- TOC entry 3784 (class 1259 OID 109193)
-- Name: IX_RelationshipSuggestions_TownStatus; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_RelationshipSuggestions_TownStatus" ON public."RelationshipSuggestions" USING btree ("TownId", "Status", "CreatedAt") WHERE ("IsDeleted" = false);


--
-- TOC entry 3785 (class 1259 OID 109188)
-- Name: IX_RelationshipSuggestions_TreeId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_RelationshipSuggestions_TreeId" ON public."RelationshipSuggestions" USING btree ("TreeId");


--
-- TOC entry 3643 (class 1259 OID 71240)
...
--
-- TOC entry 3644 (class 1259 OID 71241)
...
--
-- TOC entry 3792 (class 1259 OID 109239)
-- Name: IX_SuggestionComments_SuggestionId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_SuggestionComments_SuggestionId" ON public."SuggestionComments" USING btree ("SuggestionId");


--
-- TOC entry 3788 (class 1259 OID 109218)
-- Name: IX_SuggestionEvidence_MediaId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_SuggestionEvidence_MediaId" ON public."SuggestionEvidence" USING btree ("MediaId") WHERE ("MediaId" IS NOT NULL);


--
-- TOC entry 3789 (class 1259 OID 109217)
-- Name: IX_SuggestionEvidence_SuggestionId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_SuggestionEvidence_SuggestionId" ON public."SuggestionEvidence" USING btree ("SuggestionId");


--
-- TOC entry 3647 (class 1259 OID 71249)
...
--
-- TOC entry 3773 (class 1259 OID 108872)
...
--
-- TOC entry 3774 (class 1259 OID 108871)
...
--
-- TOC entry 3775 (class 1259 OID 108873)
...
--
-- TOC entry 3727 (class 1259 OID 72821)
...
--
-- TOC entry 3728 (class 1259 OID 72820)
...
--
-- TOC entry 3711 (class 1259 OID 72696)
...
--
-- TOC entry 3712 (class 1259 OID 72697)
...
--
-- TOC entry 3713 (class 1259 OID 72695)
...
--
-- TOC entry 3623 (class 1259 OID 71182)
...
--
-- TOC entry 3619 (class 1259 OID 108898)
-- Name: IX_Unions_IsDeleted; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_Unions_IsDeleted" ON public."Unions" USING btree ("IsDeleted") WHERE ("IsDeleted" = false);


--
-- TOC entry 3620 (class 1259 OID 71163)
...
--
-- TOC entry 3588 (class 1259 OID 71043)
...
--
-- TOC entry 3661 (class 1259 OID 72476)
...
--
-- TOC entry 3667 (class 1259 OID 72473)
...
--
-- TOC entry 3634 (class 1259 OID 106080)
...
--
-- TOC entry 3635 (class 1259 OID 106081)
...
--
-- TOC entry 3612 (class 1259 OID 106087)
...
--
-- TOC entry 3613 (class 1259 OID 106085)
...
--
-- TOC entry 3614 (class 1259 OID 106089)
...
--
-- TOC entry 3615 (class 1259 OID 106084)
...
--
-- TOC entry 3616 (class 1259 OID 106088)
...
--
-- TOC entry 3617 (class 1259 OID 106076)
...
--
-- TOC entry 3618 (class 1259 OID 106086)
...
--
-- TOC entry 3691 (class 1259 OID 72482)
...
--
-- TOC entry 3662 (class 1259 OID 72477)
...
--
-- TOC entry 3697 (class 1259 OID 72484)
...
--
-- TOC entry 3626 (class 1259 OID 106082)
...
--
-- TOC entry 3627 (class 1259 OID 106083)
...
--
-- TOC entry 3668 (class 1259 OID 72474)
...
--
-- TOC entry 3669 (class 1259 OID 72475)
...
--
-- TOC entry 3670 (class 1259 OID 72966)
...
--
-- TOC entry 3692 (class 1259 OID 72483)
...
--
-- TOC entry 3871 (class 2620 OID 109261)
-- Name: RelationshipSuggestions tr_suggestion_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER tr_suggestion_updated_at BEFORE UPDATE ON public."RelationshipSuggestions" FOR EACH ROW EXECUTE FUNCTION public.fn_update_suggestion_timestamp();


--
-- TOC entry 4091 (class 0 OID 0)
-- Dependencies: 3871
-- Name: TRIGGER tr_suggestion_updated_at ON "RelationshipSuggestions"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER tr_suggestion_updated_at ON public."RelationshipSuggestions" IS 'Automatically updates UpdatedAt timestamp when suggestion is modified';


--
-- TOC entry 3837 (class 2606 OID 72663)
...
--
-- TOC entry 3838 (class 2606 OID 72658)
...
--
-- TOC entry 3839 (class 2606 OID 72653)
...
--
-- TOC entry 3853 (class 2606 OID 73067)
...
--
-- TOC entry 3854 (class 2606 OID 73062)
...
--
-- TOC entry 3855 (class 2606 OID 73057)
...
--
-- TOC entry 3831 (class 2606 OID 72515)
...
--
-- TOC entry 3825 (class 2606 OID 72485)
...
--
-- TOC entry 3826 (class 2606 OID 72490)
...
--
-- TOC entry 3827 (class 2606 OID 72495)
...
--
-- TOC entry 3828 (class 2606 OID 72500)
...
--
-- TOC entry 3829 (class 2606 OID 72505)
...
--
-- TOC entry 3830 (class 2606 OID 72510)
...
--
-- TOC entry 3824 (class 2606 OID 106826)
...
--
-- TOC entry 3822 (class 2606 OID 109272)
-- Name: AuditLogs FK_AuditLogs_AspNetUsers; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."AuditLogs"
    ADD CONSTRAINT "FK_AuditLogs_AspNetUsers" FOREIGN KEY ("ActorId") REFERENCES public."AspNetUsers"("Id") ON DELETE SET NULL;


--
-- TOC entry 3823 (class 2606 OID 109240)
-- Name: AuditLogs FK_AuditLogs_Suggestion; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."AuditLogs"
    ADD CONSTRAINT "FK_AuditLogs_Suggestion" FOREIGN KEY ("SuggestionId") REFERENCES public."RelationshipSuggestions"("Id") ON DELETE SET NULL;


--
-- TOC entry 3849 (class 2606 OID 73012)
...
--
-- TOC entry 3850 (class 2606 OID 73032)
...
--
-- TOC entry 3851 (class 2606 OID 73027)
...
--
-- TOC entry 3852 (class 2606 OID 73017)
...
--
-- TOC entry 3816 (class 2606 OID 71223)
...
--
-- TOC entry 3817 (class 2606 OID 71218)
...
--
-- TOC entry 3818 (class 2606 OID 72888)
...
--
-- TOC entry 3797 (class 2606 OID 72550)
...
--
-- TOC entry 3798 (class 2606 OID 71052)
...
--
-- TOC entry 3795 (class 2606 OID 73042)
...
--
-- TOC entry 3813 (class 2606 OID 71198)
...
--
-- TOC entry 3814 (class 2606 OID 108886)
-- Name: ParentChildren FK_ParentChildren_DeletedByUser; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ParentChildren"
    ADD CONSTRAINT "FK_ParentChildren_DeletedByUser" FOREIGN KEY ("DeletedByUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE SET NULL;


--
-- TOC entry 3815 (class 2606 OID 71193)
...
--
-- TOC entry 3801 (class 2606 OID 71107)
...
--
-- TOC entry 3802 (class 2606 OID 71112)
...
--
-- TOC entry 3803 (class 2606 OID 108879)
-- Name: People FK_People_DeletedByUser; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."People"
    ADD CONSTRAINT "FK_People_DeletedByUser" FOREIGN KEY ("DeletedByUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE SET NULL;


--
-- TOC entry 3804 (class 2606 OID 73022)
...
--
-- TOC entry 3805 (class 2606 OID 106670)
...
--
-- TOC entry 3806 (class 2606 OID 71102)
...
--
-- TOC entry 3845 (class 2606 OID 72957)
...
--
-- TOC entry 3846 (class 2606 OID 72952)
...
--
-- TOC entry 3820 (class 2606 OID 71257)
...
--
-- TOC entry 3821 (class 2606 OID 71262)
...
--
-- TOC entry 3799 (class 2606 OID 71072)
...
--
-- TOC entry 3800 (class 2606 OID 71077)
...
--
-- TOC entry 3859 (class 2606 OID 109182)
-- Name: RelationshipSuggestions FK_RelationshipSuggestions_DeletedBy; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "FK_RelationshipSuggestions_DeletedBy" FOREIGN KEY ("DeletedByUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE SET NULL;


--
-- TOC entry 3860 (class 2606 OID 109177)
-- Name: RelationshipSuggestions FK_RelationshipSuggestions_ReviewedBy; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "FK_RelationshipSuggestions_ReviewedBy" FOREIGN KEY ("ReviewedByUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE SET NULL;


--
-- TOC entry 3861 (class 2606 OID 109162)
-- Name: RelationshipSuggestions FK_RelationshipSuggestions_SecondaryPerson; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "FK_RelationshipSuggestions_SecondaryPerson" FOREIGN KEY ("SecondaryPersonId") REFERENCES public."People"("Id") ON DELETE SET NULL;


--
-- TOC entry 3862 (class 2606 OID 109172)
-- Name: RelationshipSuggestions FK_RelationshipSuggestions_SubmittedBy; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "FK_RelationshipSuggestions_SubmittedBy" FOREIGN KEY ("SubmittedByUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE RESTRICT;


--
-- TOC entry 3863 (class 2606 OID 109157)
-- Name: RelationshipSuggestions FK_RelationshipSuggestions_TargetPerson; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "FK_RelationshipSuggestions_TargetPerson" FOREIGN KEY ("TargetPersonId") REFERENCES public."People"("Id") ON DELETE SET NULL;


--
-- TOC entry 3864 (class 2606 OID 109167)
-- Name: RelationshipSuggestions FK_RelationshipSuggestions_TargetUnion; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "FK_RelationshipSuggestions_TargetUnion" FOREIGN KEY ("TargetUnionId") REFERENCES public."Unions"("Id") ON DELETE SET NULL;


--
-- TOC entry 3865 (class 2606 OID 109147)
-- Name: RelationshipSuggestions FK_RelationshipSuggestions_Town; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "FK_RelationshipSuggestions_Town" FOREIGN KEY ("TownId") REFERENCES public."Towns"("Id") ON DELETE RESTRICT;


--
-- TOC entry 3866 (class 2606 OID 109152)
-- Name: RelationshipSuggestions FK_RelationshipSuggestions_Tree; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."RelationshipSuggestions"
    ADD CONSTRAINT "FK_RelationshipSuggestions_Tree" FOREIGN KEY ("TreeId") REFERENCES public."Orgs"("Id") ON DELETE RESTRICT;


--
-- TOC entry 3869 (class 2606 OID 109234)
-- Name: SuggestionComments FK_SuggestionComments_Author; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SuggestionComments"
    ADD CONSTRAINT "FK_SuggestionComments_Author" FOREIGN KEY ("AuthorUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE RESTRICT;


--
-- TOC entry 3870 (class 2606 OID 109229)
-- Name: SuggestionComments FK_SuggestionComments_Suggestion; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SuggestionComments"
    ADD CONSTRAINT "FK_SuggestionComments_Suggestion" FOREIGN KEY ("SuggestionId") REFERENCES public."RelationshipSuggestions"("Id") ON DELETE CASCADE;


--
-- TOC entry 3867 (class 2606 OID 109212)
-- Name: SuggestionEvidence FK_SuggestionEvidence_Media; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SuggestionEvidence"
    ADD CONSTRAINT "FK_SuggestionEvidence_Media" FOREIGN KEY ("MediaId") REFERENCES public."MediaFiles"("Id") ON DELETE SET NULL;


--
-- TOC entry 3868 (class 2606 OID 109207)
-- Name: SuggestionEvidence FK_SuggestionEvidence_Suggestion; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SuggestionEvidence"
    ADD CONSTRAINT "FK_SuggestionEvidence_Suggestion" FOREIGN KEY ("SuggestionId") REFERENCES public."RelationshipSuggestions"("Id") ON DELETE CASCADE;


--
-- TOC entry 3856 (class 2606 OID 108861)
...
--
-- TOC entry 3857 (class 2606 OID 108856)
...
--
-- TOC entry 3858 (class 2606 OID 108866)
...
--
-- TOC entry 3810 (class 2606 OID 108900)
-- Name: UnionMembers FK_UnionMembers_DeletedByUser; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."UnionMembers"
    ADD CONSTRAINT "FK_UnionMembers_DeletedByUser" FOREIGN KEY ("DeletedByUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE SET NULL;


--
-- TOC entry 3811 (class 2606 OID 71177)
...
--
-- TOC entry 3812 (class 2606 OID 71172)
...
--
-- TOC entry 3807 (class 2606 OID 108893)
-- Name: Unions FK_Unions_DeletedByUser; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Unions"
    ADD CONSTRAINT "FK_Unions_DeletedByUser" FOREIGN KEY ("DeletedByUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE SET NULL;


--
-- TOC entry 3808 (class 2606 OID 71158)
...
--
-- TOC entry 3809 (class 2606 OID 71153)
...
--
-- TOC entry 3832 (class 2606 OID 72520)
...
--
-- TOC entry 3819 (class 2606 OID 72723)
...
--
-- TOC entry 3847 (class 2606 OID 72979)
...
--
-- TOC entry 3848 (class 2606 OID 72984)
...
--
-- TOC entry 3796 (class 2606 OID 72598)
...
--
-- TOC entry 3833 (class 2606 OID 72636)
...
--
-- TOC entry 3834 (class 2606 OID 72631)
...
--
-- TOC entry 3835 (class 2606 OID 72621)
...
--
-- TOC entry 3836 (class 2606 OID 72626)
...
--
-- TOC entry 3843 (class 2606 OID 72716)
...
--
-- TOC entry 3844 (class 2606 OID 72711)
...
--
-- TOC entry 3840 (class 2606 OID 72690)
...
--
-- TOC entry 3841 (class 2606 OID 72685)
...
--
-- TOC entry 3842 (class 2606 OID 72680)
...
-- Completed on 2026-01-27 17:26:12

--
-- PostgreSQL database dump complete
--

\unrestrict CvHkbfraqY1rnyvESajHdUrUqI0TEaoeWGCJd96O9ajMlLwcNd7YOaFgw2eV0L6
