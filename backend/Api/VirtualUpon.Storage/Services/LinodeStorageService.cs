...
namespace VirtualUpon.Storage.Services
{
    public class LinodeStorageClient : IStorageService
    {
        ...
        /// <summary>
        /// Generates a pre-signed URL for secure file access from Linode Object Storage.
        /// </summary>
        public Task<SignedUrlResponseDto> GetSignedUrlAsync(string filePath, int expiresInSeconds = 3600)
        {
            ...
            catch (AmazonS3Exception ex)
            {
                ...
                {
                    IsSuccessful = false,
                    ErrorMessage = $"Linode S3 error generating signed URL: {ex.Message}"
                });
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Not applicable for Linode Object Storage. Always returns false.
        /// </summary>
        public bool ValidateSignedToken(string fileName, string token, long expires) => false;

        /// <summary>
        /// Not applicable for Linode Object Storage. Always returns null.
        /// </summary>
