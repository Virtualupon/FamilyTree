-- ============================================================================
-- Migration: Add Town Name and Country Name to Search Results
-- Date: 2026-01-21
-- Description: Updates search_persons_unified to include town name fields
--              and country name fields (fallback when no town)
-- ============================================================================

-- Drop and recreate the function with town name and country name fields
...
COMMENT ON FUNCTION public.search_persons_unified IS
    'Unified person search with father, grandfather, tree name, town name, and country name support';
