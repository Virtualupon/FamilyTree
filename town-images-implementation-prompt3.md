...
| Title | VARCHAR(200) | NULL | Optional image title (default) |
| TitleNb | VARCHAR(200) | NULL | Nobiin (Nubian) title |
| TitleAr | VARCHAR(200) | NULL | Arabic title |
| TitleEn | VARCHAR(200) | NULL | English title |
| Description | VARCHAR(500) | NULL | Optional description (default) |
| DescriptionNb | VARCHAR(500) | NULL | Nobiin description |
...
public class TownImageController : ControllerBase
{
        ...
        CancellationToken ct)
    {
        ...
        var image = new TownImage
        {
            ...
            Title = request.Title,
            TitleNb = request.TitleNb,
            TitleAr = request.TitleAr,
            TitleEn = request.TitleEn,
            Description = request.Description,
            DescriptionNb = request.DescriptionNb,
